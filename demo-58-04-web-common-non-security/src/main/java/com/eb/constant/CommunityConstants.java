...
public final class CommunityConstants {
    ...
    public static final String ENUM_EXCEL_FIELD_PREFIX_PAY_TYPE = "pay-type";
    public static final String ENUM_EXCEL_FIELD_PREFIX_SVIP_AUDIT_STATUS = "svip-audit-status";
}
