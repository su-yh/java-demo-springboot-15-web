package com.suyh5804.mvc.response;

import com.suyh5804.mvc.response.annotation.WrapperResponseAdvice;
import com.suyh5804.mvc.vo.ResponseResult;
...
public class BaseResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(@NonNull MethodParameter returnType, @NonNull Class<? extends HttpMessageConverter<?>> converterType) {
        ...
        if (!containingClass.getPackage().getName().startsWith("com.suyh5804.business.controller")) {
            return false;
        }
