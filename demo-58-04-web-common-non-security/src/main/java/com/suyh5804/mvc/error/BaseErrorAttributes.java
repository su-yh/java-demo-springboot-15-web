package com.suyh5804.mvc.error;

import com.suyh5804.constant.ErrorCodeConstants;
import com.suyh5804.mvc.exception.BaseException;
import com.suyh5804.mvc.exception.ExceptionCategory;
import com.suyh5804.util.ResponseUtils;
...
public class BaseErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(WebRequest webRequest, ErrorAttributeOptions options) {
        ...
        if (throwable != null) {
            ...
            String messageSourceCode = ResponseUtils.MESSAGE_PREFIX + code;
            Locale locale = webRequest.getLocale();
            String message = messageSource.getMessage(messageSourceCode, null, "UNKNOWN ERROR", locale);
